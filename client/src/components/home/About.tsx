...
export default function About() {
  return (
    <section id="about" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-[#0B281F]/[0.02] -translate-y-1/3 translate-x-1/4 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-[#D4AF37]/[0.03] translate-y-1/3 -translate-x-1/4 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10 font-arabic">
                <div className="flex items-center justify-end gap-3 bg-[#FAFAF8] p-4 rounded-xl border border-gray-100 hover:border-[#D4AF37]/40 hover:shadow-md transition-all duration-300">
