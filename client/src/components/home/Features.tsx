...
export default function Features() {
  return (
    <section className="py-24 bg-[#FAFAF8] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 right-0 w-80 h-80 rounded-full bg-[#D4AF37]/[0.03] blur-3xl pointer-events-none" />
      <div className="absolute top-1/2 -translate-y-1/2 left-0 w-64 h-64 rounded-full bg-[#0B281F]/[0.02] blur-3xl pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          {features.map((feature, idx) => (
            ...
            >
              <div className="relative mx-auto mb-8">
                <div className="w-24 h-28 mx-auto bg-white border border-gray-100 rounded-t-full flex items-center justify-center shadow-md group-hover:shadow-lg group-hover:border-[#D4AF37]/30 transition-all duration-300 relative overflow-hidden">
        ...
        >
          <div className="inline-flex items-center gap-3 bg-[#0B281F] text-white px-8 py-4 rounded-full shadow-lg">
