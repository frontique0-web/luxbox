...
async function seed() {
  ...
  try {
    ...
    const productsData = [
      // Perfumes
      { name: "Royal Essence", price: "$45", categoryId: 1, subcategoryId: 1, badge: "ORIGINAL", imageUrl: "/assets/product-placeholder-1.png", description: "Premium French perfume with luxurious notes", displayOrder: 1 },
      { name: "Desert Oud", price: "$20", categoryId: 1, subcategoryId: 2, badge: "LOCAL", imageUrl: "/assets/product-placeholder-1.png", description: "Authentic Emirati oud fragrance", displayOrder: 2 },
      { name: "Savage Copy", price: "$12", categoryId: 1, subcategoryId: 3, badge: "COPY 1", imageUrl: "/assets/product-placeholder-1.png", description: "High-quality inspired fragrance", displayOrder: 3 },

      // Makeup & Care
      { name: "Matte Lipstick Set", price: "$15", categoryId: 2, subcategoryId: 4, badge: "ORIGINAL", imageUrl: "/assets/product-placeholder-1.png", description: "Long-lasting matte lipstick collection", displayOrder: 1 },
      { name: "Hydrating Serum", price: "$18", categoryId: 2, subcategoryId: 5, badge: "ORGANIC", imageUrl: "/assets/product-placeholder-1.png", description: "Natural hydrating serum for all skin types", displayOrder: 2 },

      // Watches
      { name: "Rolex Master", price: "$120", categoryId: 3, subcategoryId: 6, badge: "MASTER", imageUrl: "/assets/product-placeholder-1.png", description: "Premium master copy timepiece", displayOrder: 1 },
      { name: "Casio Vintage", price: "$30", categoryId: 3, subcategoryId: 8, badge: "ORIGINAL", imageUrl: "/assets/product-placeholder-1.png", description: "Authentic vintage Casio watch", displayOrder: 2 },

      // Accessories
      { name: "Gold Plated Set", price: "$35", categoryId: 4, subcategoryId: 9, badge: "NEW", imageUrl: "/assets/product-placeholder-1.png", description: "Complete jewelry set with gold plating", displayOrder: 1 },
      { name: "Diamond Studs", price: "$9", categoryId: 4, subcategoryId: 11, badge: "ELEGANT", imageUrl: "/assets/product-placeholder-1.png", description: "Elegant cubic zirconia earrings", displayOrder: 2 },
    ];
